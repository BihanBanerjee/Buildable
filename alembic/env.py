...
# greenlet is a low-level concurrency library that SQLAlchemy's async engine requires internally. It doesn't get pulled in automatically with just sqlalchemy and asyncpg —
# you need to add it explicitly.

# this is the Alembic Config object, which provides
# access to the values within the .ini file in use.
config = context.config

# Override sqlalchemy.url with DATABASE_URL from .env (async driver)
